...
export const ADMIN_API = "http://localhost:8080/admin";
export const DOCTOR_API = "http://localhost:8080/doctor";
export const PATIENT_API = "http://localhost:8080/patient";